...
activities = {
    ...
    "Basketball Team": {
        "description": "Develop basketball skills through drills and friendly matches",
    ...
    "Drama Club": {
        "description": "Perform scenes, build confidence, and practice stagecraft",
    ...
    "Math Club": {
        "description": "Tackle puzzles, problem-solving, and math competitions",
